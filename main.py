...
numVar = int(linha1.split()[0])#numero de variaveis
numRest = int(linha1.split()[1])#numero de restrinções
...
for i in range(1, numRest+1):#Vamos pegar os valores das N linhas relacionadas as restrinções
